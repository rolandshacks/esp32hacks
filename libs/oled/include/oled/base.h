...
class Rectangle {
    ...
    public:
        ...
        Rectangle(uint8_t l, uint8_t r, uint8_t t, uint8_t b) : left(l), right(r), top(t), bottom(b) {}
        Rectangle(const Rectangle& r) : left(r.left), right(r.right), top(r.top), bottom(r.bottom) {}
